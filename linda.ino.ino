...
// WiFi Credentials
const char* ssid = "LINDAH123";
const char* password = "GOD'S SON 37425#.";
...
String htmlPage()
{
  ...
  <head>
      ...
      <title>AUMA LINAD GRACE - Smart Lighting</title>
      <style>
          body {
  ...
  <body>
      <h1>AUMA LIINDA GRACE Systems</h1>
      ...
      <footer>&copy; 2025 AUMA LINDA GRACE Systems | BYTEBLOOM GAT301</footer>
  </body>
  </html>
  )rawliteral";
